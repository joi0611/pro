...
const paperBridgeValue = {
  ...
  questions: [
    ...
    q(24, ["sleepy", "unfair", "worried"], "worried", "形容词副词", "逻辑推理", ["wasn’t sure what I could do", "made everyone excited"], "圈出 But 形成的转折：大家很兴奋，但 Mario 不确定自己能做什么，因此感到 worried。sleepy 是困倦，unfair 是不公平，都与这种担忧不符。"),
...
const unexpectedSpringPicnic = {
  ...
  questions: [
    ...
    q(13, ["wind", "magic", "music", "fog"], "magic", "名词", "情感态度 / 逻辑推理", ["Wow! It’s like","something amazing happened"], "蝴蝶、兔子和成群飞鸟构成奇妙景象，像魔法一样。"),
    q(14, ["and", "or", "but", "so"], "but", "连词逻辑", "逻辑推理", ["never made it", "didn’t matter"], "没去成农场是遗憾，后面却说这已经不重要，前后构成转折，因此选 but。and 表并列，or 表选择，so 表结果。"),
    q(15, ["hide", "lose", "forget"], "hide", "动词", "逻辑推理 / 主旨升华", ["disappointments may", "unexpected wonders"], "全文表达失望中可能隐藏着意想不到的惊喜，hide 符合主旨。")
  ],
  verifySentences: [
...
const jacksBirthdayPicnic = {
  ...
  questions: [
    ...
    q(10, ["game", "morning", "birthday"], "birthday", "名词", "上下文复现 / 主旨升华", ["lovely morning", "Mum and Dad"], "首句写 Jack 的生日有一个完美开端，结尾用 perfect ending 形成首尾呼应，因此选 birthday。game 和 morning 都不能概括全天经历。")
  ],
  verifySentences: [
...
const lessonOfLove = {
  ...
  passage: [
    ...
    { blank: 13 },
    " to pay the bill and started walking out peacefully with his mother. Hu gave a lesson to every child and ",
    { blank: 14 },
