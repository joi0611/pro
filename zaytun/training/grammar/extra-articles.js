...
addExamArticle("gaokao2026Daji", {
  ...
  questions: [
    ...
    { no: 61, prompt: "", answers: ["that", "which"], options: ["what", "who", "that", "where"], hasPrompt: false, mapNode: "blank", noPromptType: "连词", noPromptTypeOptions: ["冠词", "介词", "连词", "代词"], point: "定语从句关系代词", clue: "goods / they needed", explain: "先行词 the goods 指物，关系词在从句中作 needed 的宾语，用 that 或 which。" },
