...
addExamArticle("threeVisitsThatchedCottage", {
  ...
  questions: [
    ...
    { no: 78, prompt: "", answers: ["on"], options: ["in", "on", "at", "for"], hasPrompt: false, mapNode: "blank", noPromptType: "介词", noPromptTypeOptions: ["冠词", "介词", "连词", "代词"], point: "具体某一天用 on", clue: "a cold snowy day", explain: "表示“在具体的某一天”用介词 on。空后是 a cold snowy day，句首首字母大写为 On。" },
    ...
    { no: 84, prompt: "(successfully)", answers: ["successfully"], options: ["success", "successful", "successfully", "succeed"], hasPrompt: true, pos: "形容词与副词", mapNode: "adj", posOptions: ["名词", "动词", "形容词与副词", "数词", "代词"], focus: "副词修饰动词", focusOptions: ["比较级与最高级", "形容词变名词", "形容词变副词", "副词修饰动词"], point: "副词修饰动词", clue: "built", explain: "空处修饰动词 built，使用副词 successfully。若原题括号中已经给出 successfully，则保持副词形式即可。" }
  ],
  paragraphs: [
