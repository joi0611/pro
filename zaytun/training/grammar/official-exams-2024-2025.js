(function () {
  ...
  addExamArticle("xinjiangOfficialGrammar2024", {
    ...
    questions: [
      ...
      { no: 56, prompt: "", answers: ["but"], options: ["and", "but", "so", "because"], hasPrompt: false, mapNode: "blank", noPromptType: "连词", noPromptTypeOptions: ["冠词", "介词", "连词", "代词"], noPromptFocus: "转折连词", point: "转折关系", clue: "takes me one week / never feel tired", explain: "制作耗时一周与从不厌倦构成转折，用but。" },
